  ...
  return (
    <div className="tech-circle">
      ...
      >
        ...
        <motion.div className="icon i8" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 0.8, duration: 1 }} viewport={{ once: true }}><SiAngular /></motion.div>
        <motion.div className="icon i9" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 0.9, duration: 1 }} viewport={{ once: true }}><SiNestjs /></motion.div>
